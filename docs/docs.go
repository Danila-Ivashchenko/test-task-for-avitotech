...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/user/get/persent": {
            "post": {
                ...
                "operationId": "get-persent-users",
                "parameters": [
                    {
                        "description": "persent of users",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/user_in_segment/add/persent": {
            "post": {
                ...
                "summary": "bind users and segments",
                "operationId": "add-users-persent-to-segments",
                "parameters": [
                    {
                        "description": "persent of users and segments names",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.PersentOfUsersToSegmentsDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.PersentOfUsersToSegmentsDTO": {
            "type": "object",
            "properties": {
                "persent": {
                    "type": "number"
