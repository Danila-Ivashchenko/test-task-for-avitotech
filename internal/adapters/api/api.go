...
func (a api) bind() {
	...
	a.server.POST("user/get/percent", a.userHandler.GetPercentOfUsersIds)
	...
	a.server.POST("user_in_segment/add/percent", a.userInSegmentHandler.AddPercentOfUsersToSegments)
